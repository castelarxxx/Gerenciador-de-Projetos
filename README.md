...
### 3. Adicionar Driver MySQL no IntelliJ
...
private static final String URL = "jdbc\:mysql://localhost:3306/gerenciador\_projetos";
...
* Banco gerenciador\_projetos criado
* Usuário com privilégios necessários
